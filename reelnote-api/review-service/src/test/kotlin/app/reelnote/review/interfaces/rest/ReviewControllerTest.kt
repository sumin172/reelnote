...
class ReviewControllerTest {
    ...
    @MockkBean(relaxed = true) private lateinit var reviewService: ReviewService

    @MockkBean(relaxed = true) private lateinit var reviewQueryService: ReviewQueryService
