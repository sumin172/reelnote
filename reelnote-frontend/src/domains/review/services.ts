...
export async function fetchReviews(params: { page?: number; size?: number } = {}) {
...
export async function createReview(payload: Pick<Review, 'movieId' | 'rating' | 'reason' | 'tags' | 'watchedAt'>) {
